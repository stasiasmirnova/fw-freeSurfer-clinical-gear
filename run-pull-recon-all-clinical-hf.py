    ...
    for subject in project.subjects.iter():
        ...
        for session in subject.sessions.iter():
            ...
            for analysis in session.analyses:
                ...
                if "Recon_all_clinical" in analysis.label:
                    print('Analysis found is Recon_all_clinical:'+str(analysis.label))
...
outdir = os.path.join(project_path, 'highfield_recon_all_clinical.vol.csv')
df.to_csv(outdir)
